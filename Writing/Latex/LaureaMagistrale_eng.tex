...
\begin{figure}[!ht]
  \centering
  \subfloat[PR curves.]{\includegraphics[width=0.5\textwidth]{images/PR_curves_micro.png}\label{fig:PR_curves_micro}}
  \hfill
  \subfloat[ROC curves.]{\includegraphics[width=0.5\textwidth]{images/ROC_curves_micro.png}\label{fig:ROC_curves_micro}}
  \caption{Curves summary (micro)}
\end{figure}

\begin{figure}[!ht]
  \centering
  \subfloat[PR curves.]{\includegraphics[width=0.5\textwidth]{images/PR_curves_small-medium.png}\label{fig:PR_curves_small-medium}}
  \hfill
  \subfloat[ROC curves.]{\includegraphics[width=0.5\textwidth]{images/ROC_curves_small-medium.png}\label{fig:ROC_curves_small-medium}}
...
\begin{figure}[!ht]
  \centering
  \subfloat[Micro.]{\includegraphics[width=0.5\textwidth]{images/AUC_plots_micro.png}\label{fig:AUC_plots_micro}}
  \hfill
  \subfloat[Small-medium.]{\includegraphics[width=0.5\textwidth]{images/AUC_plots_small_medium.png}\label{fig:AUC_plots_small_medium}}
...
The final ROC curves can be found on figures \ref{fig:gbt_final_roc_curve_micro} and \ref{fig:gbt_final_roc_curve_small-medium}. The final PR curves are displayed on figures \ref{fig:gbt_final_pr_curve_micro} and \ref{fig:gbt_final_pr_curve_small-medium}.
...
Finally the first 10 most important features of the final model can be found on figures \ref{fig:gbt_final_feature_importance_micro} and \ref{fig:gbt_final_feature_importance_small-medium}.
...
&Threshold&Precision (\%)&Recall (\%)&F1 Score (\%)&ROC AUC&PR AUC\\
\midrule
LR Micro&0.5&6.72863&59.9089&12.0984&0.707312&0.109066\\
DT Micro&0.5&10.9757&44.4357&17.6033&0.690043&0.0910786\\
RF Micro&0.5&8.22654&55.5549&14.331&0.724323&0.119777\\
GBT Micro&0.5&9.83999&57.5606&16.8069&0.763539&0.145415\\
XGB Micro&0.5&8.71478&62.3346&15.2917&0.764896&0.141527\\
\bottomrule
\end{tabular}
}
\vspace{2mm}
\caption{Results summary - 3 months target (Micro)}
\label{results_summary_3m_micro}
\end{table}
...
&Threshold&Precision (\%)&Recall (\%)&F1 Score (\%)&ROC AUC&PR AUC\\
\midrule
LR Small-Medium&0.5&7.82659&63.6911&13.9402&0.709553&0.12704\\
DT Small-Medium&0.5&8.88206&61.0145&15.5068&0.721413&0.150036\\
RF Small-Medium&0.5&8.04307&66.2329&14.3442&0.727338&0.134614\\
GBT Small-Medium&0.5&10.0294&68.8129&17.5071&0.779955&0.184047\\
XGB Small-Medium&0.5&10.8309&63.0956&18.4881&0.770731&0.177088\\
\bottomrule
\end{tabular}
}
\vspace{2mm}
\caption{Results summary - 3 months target (Small-medium)}
\label{results_summary_3m_small-medium}
\end{table}

Figures [\ref{fig:PR_curves_3m_micro}, \ref{fig:ROC_curves_3m_micro}] and [\ref{fig:PR_curves_3m_small-medium}, \ref{fig:ROC_curves_3m_small-medium}] show the ROC and PR curves of the different approaches used on which we can see that the best performing model remains GBT.

\begin{figure}[!ht]
  \centering
  \subfloat[PR curves.]{\includegraphics[width=0.5\textwidth]{images/PR_curves_3m_micro.png}\label{fig:PR_curves_3m_micro}}
  \hfill
  \subfloat[ROC curves.]{\includegraphics[width=0.5\textwidth]{images/ROC_curves_3m_micro.png}\label{fig:ROC_curves_3m_micro}}
  \caption{Curves summary - 3 months target (micro)}
\end{figure}

\begin{figure}[!ht]
  \centering
  \subfloat[PR curves.]{\includegraphics[width=0.5\textwidth]{images/PR_curves_3m_small-medium.png}\label{fig:PR_curves_3m_small-medium}}
  \hfill
  \subfloat[ROC curves.]{\includegraphics[width=0.5\textwidth]{images/ROC_curves_3m_small-medium.png}\label{fig:ROC_curves_3m_small-medium}}
  \caption{Curves summary - 3 months target (small-medium)}
\end{figure}

Lastly, figures \ref{fig:AUC_plots_3m_micro} and \ref{fig:AUC_plots_3m_small_medium} clearly show that for both micro and small-medium data sets, the model having the highest AUC is Gradient Boosted Tree.

\begin{figure}[!ht]
  \centering
  \subfloat[Micro.]{\includegraphics[width=0.5\textwidth]{images/AUC_plots_3m_micro.png}\label{fig:AUC_plots_3m_micro}}
  \hfill
  \subfloat[Small-medium.]{\includegraphics[width=0.5\textwidth]{images/AUC_plots_3m_small_medium.png}\label{fig:AUC_plots_3m_small_medium}}
  \caption{Area under PR curve - 3 months target: summary}
\end{figure}

We also tested our best model on a the new target variable still obtaining good results that are summarized on table \ref{performance_on_3_months_target}.
